...
const fallbackExperience: Experience[] = [
   {
     ...
     location: "Anambra, NG",
     description: "Leading the development of the company's academy platform using React, Node.js, and PostgreSQL. Hosted on AWS cloud infracsture, Implemented CI/CD pipelines and improved application performance by 40%.",
   ...
   },
  {
    ...
    location: "Abuja, NG",
    description: "comprehensive data manipulation, editing, and refinement processes by utilizing survey solutions for the National Agricultural Sample Survey (NASS) sponsored by the World Bank. Collaborated with the software engineering team to implement real-time updates of pertinent statistical data to both their database and public website.",
    ...
    <section id="experience" className="py-20">
      <div className="container mx-auto px-8">
        <h2 className="text-5xl md:text-7xl font-extrabold leading-tight mb-8">
            RELEVANT<br /> EXPERIENCES
{/*           <span className="text-gray-500 text-xl">(2025)</span> */}
          </h2>

        <div className="relative mx-8 border-l border-border pl-12">
